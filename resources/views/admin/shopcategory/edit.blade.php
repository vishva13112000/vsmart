                                ...
                                <div class="kt-form__actions">
                                    <div class="row">
                                        <div class="col-6 form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" value="{{$shopcategory->title}}">
                                            <input type="hidden" class="form-control" id="id" name="id" value="{{$shopcategory->id}}">
        ...
        $(document).ready(function () {
            ...
            $(".submit").click(function (event) {
                ...
                if ($(".shopcategoryFrm").valid()) {
                    $.ajax({
                        type: "POST",
                        url: "{{route('admin.shopcategory.update')}}",
                        ...
                        success: function (data) {
                            if (data.status === 'success') {
                                swal({
                                    title: "Success",
                                    text: "Shop Category Updated Successfully",
                                    type: "success"
                                }, function () {
