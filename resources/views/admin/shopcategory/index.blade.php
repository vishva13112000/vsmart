                    ...
                    <div id="kt_table_1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <table class="table shopcategory table-striped- table-bordered table-hover table-checkable datatable"
                            ...
                            @foreach($shopcategories as $shopcategory)
                                <tr>
                                    <td><input type="checkbox" name="single[{{$shopcategory->id}}]" data-id="{{$shopcategory->id}}" class="form-control custom-checkbox singleselect" style="height: 15px;"</td>
                                    ...
                                    <td><a class="btn waves-effect waves-light btn-primary" href="{{route('admin.shopcategory.edit',$shopcategory->id)}}"><i class="fa fa-pen   "></i></a>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.delete-all').on('click', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('admin.shopcategory.deleteall')}}",
                ...
                success: function (data) {
                    if (data.status === 'success') {
                        swal({
                            title: "Success",
                            text: "Shop Category Deleted Successfully",
                            type: "success"
                        }, function () {
